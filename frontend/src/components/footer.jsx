    ...
    <footer className="bg-[#1E1E1E] py-16 font-imprima text-white">
      <div className="container lg:px-4">
        <div className="flex flex-wrap">
          <p className="mx-auto w-full px-6 text-[19px]/[25px] lg:text-base">
            ...
            Apa yang membedakan Bajakmovie dari platform lainnya? Nama kami
            sendiri menggambarkan segalanya - bajak movie! Kami tidak hanya
            menawarkan konten film terbaik, tetapi kami juga menyediakan
            semuanya secara gratis. Tidak ada lagi kekhawatiran tentang biaya
            berlangganan atau pembayaran per tayang. Nikmati akses tak terbatas
            ke ribuan film blockbuster, serial TV seru, dan acara eksklusif
